...
module.exports = {
	...
	*/
	/**
		Base URI for the local netfoundry. All objects and types whose URI starts with this
		string are considered "local" objects.
	*/
	baseUri: 'http://obj.netfoundry.org',
	/** Array of node types for which the netfoundry node message processor should process messages.
	*/
	processNodeTypes: [],
	/** 
