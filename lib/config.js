...
module.exports = {
	...
	*/
	...
	/** 
		...
		require string, a <tt>{Function(linkUri, direction)}</tt>, or an <tt>Object</tt> with a
	...
	*/
	linkAddProcessors: {
		...
		'my-node-type-y': function(linkUri, direction) { ... },
		'my-node-type-z': {processLinkAdd: function(linkUri, direction) { ... }}
		*/
	},
	/** 
